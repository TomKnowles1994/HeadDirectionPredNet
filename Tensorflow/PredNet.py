...
m1_inp_shape = visual_data.shape[1]         # Get visual input shape from relevant dataset
m2_inp_shape = pose_data.shape[1]           # Get pose input shape from relevant dataset
